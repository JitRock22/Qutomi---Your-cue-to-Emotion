        ...
        >
                    ...
                    {steps.slice(0, 4).map((step) => {
                        ...
                        return (
                            <motion.button
                                ...
                                whileTap={{ scale: 0.95 }}
                                className="flex flex-col items-center gap-3 p-4 rounded-xl bg-white/5 border border-white/10 text-gray-300 hover:bg-white/10 hover:text-white transition-all duration-200 group"
                            >
                                <div className={`w-12 h-12 rounded-full bg-gradient-to-r ${gradientColors[step.id]} flex items-center justify-center group-hover:scale-110 transition-all duration-200 shadow-lg`}>
            ...
            <div className="flex flex-col sm:flex-row gap-3 justify-center items-center pt-6">
                <motion.button
                    ...
                    whileTap={{ scale: 0.95 }}
                    disabled={isSubmitting}
                    className="flex items-center gap-2 px-6 py-3 rounded-xl bg-white/5 border border-white/10 text-white hover:bg-white/10 transition-all duration-300 text-sm font-medium"
                >
                ...
                <motion.button
                    ...
                    disabled={isSubmitting}
                    className={`px-8 py-3 text-white rounded-xl font-semibold transition-all duration-300 flex items-center gap-2 ${isSubmitting
                        ? "bg-gray-600 cursor-not-allowed"
            ...
            <AnimatePresence>
                {showScrollTop && (
                    <motion.button
                        ...
                        onClick={scrollToTop}
                        className="fixed right-6 bottom-6 z-40 hidden lg:flex items-center justify-center w-12 h-12 rounded-full bg-gradient-to-r from-[#F361B0] to-[#00FFFF] text-white shadow-lg hover:shadow-xl transition-all duration-300 hover:scale-110"
                        ...
                        >
                            <motion.button
                                ...
                                className={`flex items-center gap-2 px-6 py-3 rounded-xl border transition-all duration-300 ${currentStep === 1 || isSubmitting
                                    ...
                                    : "border-white/20 text-white hover:bg-white/5 backdrop-blur-sm"
                                    }`}
                            >
                                <FaArrowLeft className="text-sm" />
                                Previous
                            ...
                            <motion.button
                                ...
                                onClick={nextStep}
                                disabled={isSubmitting}
                                className="flex items-center gap-2 px-6 py-3 rounded-xl bg-gradient-to-r from-[#F361B0] to-[#00FFFF] text-white font-semibold hover:shadow-lg hover:shadow-[#F361B0]/30 transition-all duration-300 backdrop-blur-sm"
                            >
                                Next
